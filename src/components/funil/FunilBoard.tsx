...
/* Funil de vendas (Frio → Morno → Quente) partilhado entre VN e VU. Cada página
 * fornece os seus negócios já normalizados; o board trata do filtro por
 * responsável, das três tabelas e do funil visual. */
...
export type FunilStatus = keyof typeof STATUS_CONFIG;
export const FUNIL_STATUSES = Object.keys(STATUS_CONFIG) as FunilStatus[];
...
export function FunilBoard({ records }: { records: FunilRow[] }) {
