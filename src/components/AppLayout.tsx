...
import { BarChart3, TrendingUp, Briefcase, AlertTriangle, Menu, X, Database, CalendarDays, Filter, LogOut, Coins, Car, Target, Calculator, CalendarClock, Users, HeartHandshake } from 'lucide-react';
